...
public interface ListInterface<T> {
	 ...
	 * in the list, and stores them in the array starting at the 0 index.
	 * 
	...
	/**
	 * Displays the number of the items in the list and displays the contents of the
	 * list forward (using the reference to the first node and the next links) and
	 * displays the contents of the list backward (using the reference to the last
	 * node and the previous links). The the forward and backward contents should be
	 * on separate lines, with a space between items. 
	 * Example: 
	 * Number of Items: 5 
	 * A B C D E 
	 * E D C B A
